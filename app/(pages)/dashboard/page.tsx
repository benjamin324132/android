          ...
          <header className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Avatar>
                <AvatarImage
                  alt="Sanjoy_R"
                  src="https://github.com/sanjoy.png"
                />
